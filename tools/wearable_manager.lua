...
function WearableManager:AddNewWearable(hUnit, tInput)		
	...
	if sModel then
		...
		hWearable:AddNewModifier(nil, nil, "modifier_phased", {duration=-1})
		hWearable:AddNewModifier(nil, nil, "modifier_no_healthbar", {duration=-1})
		...
		if GameItems.items[sID].visuals and GameItems.items[sID].visuals.styles then
			print("zhaodaoleaaaaaaaaaaaaaaaaaaaaa")
			...
			print("zhaodaoleaaaaaaaaaaaaaaaaaaaaa2222")
